...
import type { BusinessCategorySuggestion } from "@/hooks/use-business-category-picker";
...
type Props = {
  query: string;
  suggestions: BusinessCategorySuggestion[];
  onQueryChange: (query: string) => void;
  onSuggestionSelect: (suggestion: BusinessCategorySuggestion) => void;
  onAddCustom: () => void;
