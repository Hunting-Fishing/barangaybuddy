...
export const BUSINESS_CATEGORY_GROUPS: BusinessCategoryGroup[] = [
  {
    ...
    items: [
      ...
      item("bar-and-grill", "Bar & grill", "Grilled food, drinks, pulutan, and casual night dining.", {
        businessType: "restaurant",
      ...
      item("samgyupsal-korean-grill", "Samgyupsal / Korean grill", "Korean BBQ, samgyupsal, unlimited pork, beef, side dishes, or grill tables.", {
        businessType: "restaurant",
      ...
      item("lutong-bahay-delivery", "Lutong bahay delivery", "Home-cooked meals, packed lunch, office meals, or daily ulam delivery.", {
        businessType: "food_vendor",
        customType: "Lutong bahay delivery",
        section: foodSection.restaurants,
        keywords: ["lutong bahay", "packed lunch", "ulam", "meal delivery", "baon", "home cooked"],
      }),
      ...
      item("lugawan-gotohan", "Lugawan / gotohan", "Lugaw, goto, arroz caldo, tokwa’t baboy, or warm rice porridge meals.", {
        businessType: "restaurant",
        customType: "Lugawan",
        section: foodSection.restaurants,
      ...
      item("seafood-paluto", "Seafood paluto", "Fresh seafood cooked to order, dampa-style meals, sugba, tinola, or kinilaw.", {
        businessType: "restaurant",
        customType: "Seafood paluto",
        section: foodSection.restaurants,
        keywords: ["paluto", "seafood", "dampa", "sugba", "kinilaw", "tinola", "fish"],
      }),
      item("ihawan-restaurant", "Ihawan restaurant", "Grilled meats and seafood, BBQ meals, liempo, chicken inasal, or open-grill dining.", {
        businessType: "restaurant",
      ...
      item("chicken-inasal-vendor", "Chicken inasal seller", "Chicken inasal, grilled chicken, pecho, paa, or Bacolod-style meals.", {
        businessType: "food_vendor",
      ...
      item("meryenda-snack-house", "Meryenda / snack house", "Local snacks, sandwiches, pancit, turon, drinks, or afternoon food.", {
        businessType: "food_vendor",
      ...
      item("home-baker", "Home baker", "Home-based cakes, cupcakes, cookies, brownies, pastries, or dessert trays.", {
        businessType: "bakery",
  ...
  },
  {
    ...
    icon: "services",
    items: [
      item("billiards-hall", "Billiards / pool hall", "Pool tables, billiards games, tournaments, drinks, or tambayan setup.", {
        businessType: "service",
        customType: "Billiards hall",
        section: "Games & hangouts",
        keywords: ["billiards", "pool", "pool hall", "bilyar", "tournament", "tambayan"],
      }),
      item("resto-bar-nightlife", "Resto-bar", "Food, drinks, pulutan, music, or night hangout service.", {
        businessType: "restaurant",
        customType: "Resto-bar",
        section: "Bars & nightlife",
        keywords: ["restobar", "resto bar", "bar", "inuman", "pulutan", "nightlife", "live music"],
      }),
      item("karaoke-videoke-bar", "Karaoke / videoke bar", "Videoke rooms, karaoke, singing, food, drinks, or party packages.", {
        businessType: "service",
        customType: "Karaoke bar",
        section: "Music & singing",
        keywords: ["karaoke", "videoke", "ktv", "singing", "music", "party"],
      }),
      item("ktv-lounge", "KTV lounge", "Private singing rooms, group packages, food, drinks, and celebrations.", {
        businessType: "service",
        customType: "KTV lounge",
        section: "Music & singing",
        keywords: ["ktv", "karaoke", "private room", "videoke", "lounge", "party"],
      }),
      item("live-music-bar", "Live music bar", "Acoustic nights, bands, open mic, performers, drinks, and pulutan.", {
        businessType: "restaurant",
        customType: "Live music bar",
        section: "Bars & nightlife",
        keywords: ["live band", "acoustic", "open mic", "music", "bar", "performers"],
      }),
      item("sports-bar", "Sports bar", "Sports viewing, boxing, basketball, billiards, beer, food, or group watch parties.", {
        businessType: "restaurant",
        customType: "Sports bar",
        section: "Bars & nightlife",
        keywords: ["sports bar", "boxing", "basketball", "watch party", "beer", "tv"],
      }),
      item("inuman-tambayan", "Inuman tambayan", "Casual drinks, pulutan, music, outdoor seating, or neighborhood hangout.", {
        businessType: "restaurant",
        customType: "Inuman tambayan",
        section: "Bars & nightlife",
        keywords: ["inuman", "tambayan", "pulutan", "beer", "outdoor", "night"],
      }),
      item("computer-gaming-shop", "Computer gaming shop", "PC gaming, computer rental, online games, printing, or pisonet-style service.", {
        businessType: "service",
        customType: "Computer gaming shop",
        section: "Games & hangouts",
        keywords: ["computer shop", "gaming", "pc", "pisonet", "internet cafe", "online games"],
      }),
      item("arcade-game-room", "Arcade / game room", "Arcade machines, claw machines, console rental, board games, or family games.", {
        businessType: "service",
        customType: "Arcade game room",
        section: "Games & hangouts",
        keywords: ["arcade", "claw machine", "playstation", "console", "board games", "games"],
      }),
      item("event-place", "Event place / function hall", "Birthdays, debuts, meetings, receptions, small events, or party rentals.", {
        businessType: "service",
        customType: "Event place",
        section: "Events",
        keywords: ["event place", "function hall", "venue", "birthday", "debut", "reception"],
      }),
      item("party-karaoke-rental", "Party lights / karaoke rental", "Karaoke machine, sound system, lights, tables, chairs, or party equipment rental.", {
        businessType: "service",
  ...
  },
  {
    ...
    items: [
      ...
      item("grocery-mini-mart", "Grocery / mini mart", "Groceries, frozen goods, household supplies, snacks, drinks, and pantry items.", {
        businessType: "store",
        customType: "Grocery store",
        section: "Daily essentials",
        keywords: ["grocery", "mini mart", "frozen goods", "pantry", "household supplies"],
      }),
      item("e-loading-station", "E-load / SIM / mobile load", "Prepaid load, SIM cards, data promos, e-wallet cash-in, or mobile accessories.", {
        businessType: "store",
      ...
      item("ukay-ukay", "Ukay-ukay / thrift shop", "Second-hand clothes, shoes, bags, overruns, or affordable fashion.", {
        businessType: "dry_goods",
        customType: "Ukay-ukay",
        section: "General merchandise",
        keywords: ["ukay", "thrift", "second hand", "clothes", "overruns", "bags", "shoes"],
      }),
      item("school-supplies-store", "School & office supplies", "Paper, notebooks, uniforms, printing materials, office supplies, and school needs.", {
        businessType: "store",
        customType: "School supplies store",
        section: "General merchandise",
        keywords: ["school supplies", "office supplies", "notebook", "paper", "uniform"],
      }),
      item("cellphone-accessories", "Cellphone accessories shop", "Chargers, cases, earphones, tempered glass, repairs, or gadgets.", {
        businessType: "store",
        customType: "Cellphone accessories shop",
        section: "General merchandise",
        keywords: ["cellphone", "phone case", "charger", "earphones", "tempered glass", "gadgets"],
      }),
  ...
  },
  {
    ...
    items: [
      ...
      item("tricycle-terminal", "Tricycle terminal / TODA", "Tricycle queue, TODA service, local rides, or barangay transport pickup point.", {
        businessType: "transport",
        customType: "Tricycle terminal",
        section: "Transport",
        keywords: ["tricycle", "toda", "terminal", "local rides", "pila"],
      }),
      item("motorcycle-taxi-rider", "Motorcycle taxi / rider service", "Habalan, angkas-style rides, pabili, pickup, or local motorcycle transport.", {
        businessType: "transport",
      ...
      item("motorcycle-repair", "Motorcycle repair shop", "Motorcycle maintenance, tune-up, oil change, parts replacement, or roadside repair.", {
        businessType: "repair_shop",
  ...
  },
  {
    ...
    items: [
      ...
      item("construction-supply", "Construction supply", "Cement, hollow blocks, sand, gravel, steel bars, lumber, and building materials.", {
        businessType: "hardware",
        customType: "Construction supply",
        section: "Supplies",
        keywords: ["cement", "hollow blocks", "sand", "gravel", "steel", "lumber"],
      }),
      item("hollow-blocks-maker", "Hollow blocks maker", "CHB, concrete products, paving blocks, or local construction materials.", {
        businessType: "hardware",
      ...
      item("roofing-service", "Roofing / gutter service", "Roof repair, gutters, downspouts, metal roofing, or leak fixes.", {
        businessType: "service",
  ...
  },
  {
    ...
    items: [
      ...
      item("diagnostic-lab", "Diagnostic / laboratory clinic", "Blood tests, urinalysis, x-ray, ultrasound, ECG, or medical diagnostics.", {
        businessType: "service",
      ...
      item("nail-lash-studio", "Nail / lash studio", "Manicure, pedicure, gel nails, eyelash extensions, brows, or beauty services.", {
        businessType: "salon",
      ...
      item("traditional-hilot", "Traditional hilot", "Hilot, wellness massage, home service bodywork, or traditional therapy.", {
        businessType: "service",
  ...
  },
  {
    ...
    items: [
      ...
      item("cleaning-service", "House cleaning service", "Home cleaning, deep cleaning, move-out cleaning, or helper services.", {
        businessType: "service",
      ...
      item("tarpaulin-printing", "Tarpaulin / signage printing", "Tarpaulins, stickers, signages, invitations, layouts, and large-format printing.", {
        businessType: "service",
      ...
      item("pawnshop", "Pawnshop", "Sangla, jewelry pawn, remittance, bills payment, or money services.", {
        businessType: "service",
        customType: "Pawnshop",
        section: "Money services",
      ...
      item("cellphone-repair", "Cellphone repair", "Phone repair, screen replacement, battery replacement, charging port, or gadget repair.", {
        businessType: "repair_shop",
      ...
      item("appliance-repair", "Appliance repair", "Electric fan, TV, washing machine, refrigerator, aircon, or small appliance repair.", {
        businessType: "repair_shop",
      ...
      item("event-stylist", "Event stylist / party decorator", "Balloon decor, backdrops, party styling, flowers, and event setup.", {
        businessType: "service",
        customType: "Event stylist",
        section: "Events",
        keywords: ["event stylist", "party decorator", "balloons", "backdrop", "flowers"],
      }),
      item("photo-video-service", "Photo / video service", "Photography, videography, photo booth, event coverage, or editing.", {
        businessType: "service",
  ...
  },
  {
    ...
    items: [
      ...
      item("talipapa", "Talipapa / mini market", "Small neighborhood market for fish, meat, vegetables, fruits, or daily food needs.", {
        businessType: "wet_market",
        customType: "Talipapa",
        section: "Market stalls",
      ...
      item("fish-stall", "Fish stall", "Fresh fish, seafood, shellfish, dried fish, or seafood market seller.", {
        businessType: "market_vendor",
        customType: "Fish stall",
        section: "Specialty vendors",
        keywords: ["fish", "isda", "seafood", "shellfish", "tuyo", "palengke"],
      }),
      item("fruit-vegetable-stand", "Fruit / vegetable stand", "Fresh fruits, vegetables, herbs, crops, and local produce.", {
        businessType: "market_vendor",
        customType: "Fruit and vegetable stand",
        section: "Specialty vendors",
        keywords: ["fruit", "vegetables", "gulay", "prutas", "produce", "market"],
      }),
      item("egg-poultry-vendor", "Egg / poultry vendor", "Eggs, dressed chicken, poultry products, or frozen poultry.", {
        businessType: "market_vendor",
  ...
  },
  {
    ...
    items: [
      ...
      item("feeds-supply", "Feeds supply", "Animal feeds, vitamins, poultry supplies, hog feeds, and livestock needs.", {
        businessType: "agri_supply",
        customType: "Feeds supply",
        section: "Farm supplies",
        keywords: ["feeds", "hog feeds", "poultry feeds", "vitamins", "livestock"],
      }),
      item("seedling-plant-nursery", "Seedling / plant nursery", "Seedlings, ornamental plants, fruit trees, garden soil, and planting supplies.", {
        businessType: "agri_supply",
      ...
      item("fishpond-aquaculture", "Fishpond / aquaculture", "Tilapia, bangus, hito, shrimp farming, fishpond harvests, or aquaculture supplies.", {
        businessType: "fisher",
        customType: "Fishpond",
        section: "Farm services",
  ...
  },
  {
    ...
    icon: "services",
    items: [
      item("resort", "Resort", "Pool resort, beach resort, family resort, cottages, day tour, or overnight stay.", {
        businessType: "service",
        customType: "Resort",
        section: "Stay & leisure",
        keywords: ["resort", "pool", "beach", "cottages", "day tour", "overnight"],
      }),
      item("private-pool", "Private pool", "Private swimming pool rental, barkada outing, family events, or day-use pool.", {
        businessType: "service",
        customType: "Private pool",
        section: "Stay & leisure",
        keywords: ["private pool", "swimming", "pool rental", "outing", "day use"],
      }),
      item("transient-house", "Transient house / room", "Short-term stay, transient room, apartment, boarding, or local accommodation.", {
        businessType: "service",
        customType: "Transient house",
        section: "Stay & lodging",
        keywords: ["transient", "room", "short stay", "boarding", "accommodation", "apartment"],
      }),
      item("homestay", "Homestay", "Local home stay, guest room, family lodging, or budget accommodation.", {
        businessType: "service",
        customType: "Homestay",
        section: "Stay & lodging",
        keywords: ["homestay", "guest room", "lodging", "budget stay", "tourist"],
      }),
      item("event-venue", "Event venue", "Wedding, birthday, seminar, reception, party, or function venue.", {
        businessType: "service",
        customType: "Event venue",
        section: "Events",
        keywords: ["event venue", "wedding", "birthday", "seminar", "reception", "function"],
      }),
      item("tour-guide", "Tour guide / local guide", "Local tours, island hopping, hiking guide, heritage walks, or travel assistance.", {
        businessType: "service",
        customType: "Tour guide",
        section: "Tours",
        keywords: ["tour guide", "local guide", "island hopping", "hiking", "travel", "tour"],
      }),
      item("boat-rental", "Boat rental", "Island hopping, banca rental, fishing trips, river tours, or coastal transport.", {
        businessType: "transport",
