...
function CategoryPage() {
  ...
  const businessTypes = [
    ...new Set(group.items.map((item) => item.businessType).filter(Boolean)),
  ];
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_340px]">
          <section>
            <div className="flex flex-wrap items-end justify-between gap-3">
              <div>
                <h2 className="font-display text-2xl font-bold">Choose a type</h2>
                <p className="mt-1 text-sm text-muted-foreground">
                  Select the closest match to search businesses in this category.
                </p>
              </div>
